...
plot(projdata$dt, projdata$Sub_metering_1, type = "l", col = "black", xlab = "", ylab = "Energy Sub-Metering")
lines(projdata$dt, projdata$Sub_metering_2, type = "l", col = "red")
lines(projdata$dt, projdata$Sub_metering_3, type = "l", col = "blue")
